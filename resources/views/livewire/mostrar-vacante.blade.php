<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-50 p-4 my-10">
            ...
            <p class="font-bold text-sm uppercase text-gray-800 my-3">Categoria:
                {{-- Aca para acceder a los atributos de categoria, creamos una funcion  para relacionarlo en el modelo Vacante.php --}}
    ...
    @guest
        <div class="mt-5 bg-gray-50 borrder border-dashed p-5 text-center">
            <p>
                ¿Deseas aplicar a esta vacante?
                <a class="font-bold text-indigo-600" href="{{ route('register') }}"> Obten una cuenta y aplica a esta y
                    otras vacantes.</a>
            </p>
        </div>
    @endguest
    @auth
        ...
        @else
            {{-- esto debe estar visible solo para devs rol=1 --}}
            {{-- Pasamos la variable vacante para mostrarlo en postular vacante --}}
